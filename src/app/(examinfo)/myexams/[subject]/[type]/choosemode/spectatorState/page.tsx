            ...
            <ul>
                {exams.map((exam) => (
                    <li key={exam._id} className="mb-4">
                        ...
                        <Image src={exam.imageUrl} alt={"fddf"} width={1000} height={1000} ></Image>
                        {showAnswers?.has(exam._id) ? (
                            <Button 
                                className="!rounded-full !px-8 !py-3 !text-lg !font-bold bg-white hover:bg-gray-300 text-white  flex items-center gap-2 shadow-sm transition"
